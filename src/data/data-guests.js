...
export const guests = [
  {
    // id: 1000,
    fullName: "Emeka Ferreira",
    email: "hello@emeka.io",
  ...
  {
    fullName: "Mark Johansson",
    email: "m_johansson@example.com",
    nationality: "Finland",
  ...
  {
    fullName: "Jose Anderson-Rizzario",
    email: "jose_rizz@example.com",
